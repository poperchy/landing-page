...
const DEFAULT_CLASSES = {
  input:
    'w-full h-[38px] px-3 py-[11px] px-[14px] border text-input-text bg-input-bg text-[13px] placeholder:text-input-placeholder placeholder:text-[13px] border-input-border rounded-[6px] focus:outline-none focus:ring-2 focus:ring-[#5AB828] caret-[#5AB828]',
  inputWithIcon: 'pr-10',
  checkbox:
  ...
  error: 'mt-1 text-[13px] text-[#F91717]',
  passwordButton:
...
const SpecialInput: React.FC<SpecialInputProps> = ({
  ...
  const getInputClassName = () => {
    return clsx(
      ...
      {
        [DEFAULT_CLASSES.inputWithIcon]: inputWithIcon,
        'border-[#F91717]': error,
      },
      className
    );
        ...
        <div className={DEFAULT_CLASSES.checkboxInputContainer}>
          <div className="relative h-[18px] w-[18px]">
            <input
              ...
              className={clsx(DEFAULT_CLASSES.checkbox, className)}
            />
    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          className={clsx(getInputClassName(), 'pl-[60px]')}
          placeholder={placeholder}
          maxLength={maxLength}
        />
      </div>
